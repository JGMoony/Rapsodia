...
urlpatterns = [
    ...
    path("admin/mesas/plano/", views.mesa_plano_view, name="mesa_plano"),
    path("admin/mesas/lista/", MesaListView.as_view(), name="mesa_list"),
    path("admin/mesas/create/", MesaCreateView.as_view(), name="mesa_create"),
    path("admin/mesas/<int:pk>/edit/", MesaUpdateView.as_view(), name="mesa_edit"),
    path("admin/mesas/<int:pk>/delete/", MesaDeleteView.as_view(), name="mesa_delete"),
